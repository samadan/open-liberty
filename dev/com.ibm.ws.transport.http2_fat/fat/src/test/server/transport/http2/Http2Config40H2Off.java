...
@Mode(TestMode.FULL)
public class Http2Config40H2Off extends FATServletClient {
    ...
    private final static LibertyServer server = LibertyServerFactory.getLibertyServer("com.ibm.ws.transport.http2.fat.servlet40.h2.off");
     ...
     */
    @Test
    public void servlet40H2Off() throws Exception {
