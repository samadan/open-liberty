...
public abstract class AbstractHttp2ConnectionHandlerBuilder<T extends Http2ConnectionHandler,
    ...
    private long maxHeaderBlockSize = 51200;
    ...
    /**
     * Set the limits on header name and value lenghts for a stream.
     * @param limitFieldSize Limits the length of every header individual name and value
     * @return {@code this}.
     */
    public B limitFieldSize(int limitFieldSize) {
        this.limitFieldSize = limitFieldSize;
        return self();
    }
    
    /**
     * Set the limits on the amount of headers allowed for a stream.
     * @param limitNumHeaders Limits the size of headers
     * @return {@code this}.
     */
    public B limitNumHeaders(int limitNumHeaders) {
     ...
     * @return {@code this}.
     */
    public B maxHeaderBlockSize(long maxHeaderBlockSize) {
    ...
    private T buildFromConnection(Http2Connection connection) {
        ...
        // Liberty change to use LibertyDefaultHttp2HeadersDecoder
        Http2FrameReader reader = new DefaultHttp2FrameReader(new LibertyDefaultHttp2HeadersDecoder(isValidateHeaders(),
