...
public class ResourceBuilder {
    ...
    public static class ResourceLocatorBuilder<T extends ResourceLocatorBuilder<T>> {
        ...
        public ResourceLocatorBuilder(final ResourceClassBuilder resourceClassBuilder, final Method method,
    ...
    public static class ResourceMethodBuilder extends ResourceLocatorBuilder<ResourceMethodBuilder> {
        ...
        public ResourceMethodBuilder(final ResourceClassBuilder resourceClassBuilder, final Method method,
                final Method annotatedMethod) {
        ...
        public ResourceMethodBuilder produces(String... produces) {
            ...
            for (MediaType mt : types) {
                if (!mt.getParameters().containsKey(MediaType.CHARSET_PARAMETER)) {
                    if (isTextLike(mt)) {
                        ResteasyDeployment deployment = ResteasyProviderFactory.getInstance()
                                .getContextData(ResteasyDeployment.class);
