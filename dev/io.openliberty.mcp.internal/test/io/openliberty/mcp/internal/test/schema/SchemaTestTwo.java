...
public class SchemaTestTwo {
    ...
    public void testToolInputSchema() throws NoSuchMethodException, SecurityException {
        ...
        System.out.println(toolInputSchema);
    ...
    public void testPersonCheckToolSchema() throws NoSuchMethodException, SecurityException {
        ...
        String response = SchemaRegistryTwo.getToolInputSchema(toolMetadata);
        System.out.println(response);
        String expectedResponseString = """
                        {
                            "$defs": {
    ...
    public void testAddressSchema() {
        String response = SchemaRegistryTwo.getSchema(address.class, SchemaDirection.INPUT);
        System.out.println(response);
        String expectedResponseString = """
                           {
                            "properties": {
    ...
    public void testStreetSchema() {
        String response = SchemaRegistryTwo.getSchema(street.class, SchemaDirection.INPUT);
        System.out.println(response);
        String expectedResponseString = """
                        {
                          "properties": {
    ...
    public void testCompanySchema() {
        String response = SchemaRegistryTwo.getSchema(company.class, SchemaDirection.INPUT);
        System.out.println(response);
        String expectedResponseString = """
                            {
                            "$defs": {
    ...
    public void testPortfolioEntryDuplicateNameSchema() {
        String response = SchemaRegistryTwo.getSchema(PortfolioEntry.class, SchemaDirection.INPUT);
        System.out.println(response);
        String expectedResponseString = """
                            {
                            "$defs": {
    ...
    public void testPersonAddtoListToolOutputSchema() throws NoSuchMethodException, SecurityException {
        ToolMetadata toolMetadata = findTool("addPersonToList");
        String response = SchemaRegistryTwo.getToolOuputSchema(toolMetadata);
        System.out.println(response);
        String expectedResponseString = """
                            {
                            "$defs": {
    ...
    public void testEnumObject() {
        String schema = SchemaRegistryTwo.getSchema(EnumHolder.class, SchemaDirection.INPUT);
    ...
    public void testEnumKeyedMap() {
        String schema = SchemaRegistryTwo.getSchema(EnumMapHolder.class, SchemaDirection.INPUT);
    ...
    public void testOptionalPartialPersonSchema() {
        String response = SchemaRegistryTwo.getSchema(partialPerson.class, SchemaDirection.INPUT);
        System.out.println(response);
        String expectedResponseString = """
                            {
                            "$defs": {
