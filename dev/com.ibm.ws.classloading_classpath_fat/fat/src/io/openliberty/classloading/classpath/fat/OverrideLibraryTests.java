...
public class OverrideLibraryTests extends FATServletClient {

    @Server(OVERRIDE_LIB_WAR_TEST_SERVER)
    @TestServlet(servlet = OverrideLibraryTestServlet.class, contextRoot = TEST_OVERRIDE_LIB_APP)
    ...
    public static void setupTestServer() throws Exception {
        ShrinkHelper.exportAppToServer(server, TEST_OVERRIDE_LIB_WAR, DeployOptions.SERVER_ONLY);
