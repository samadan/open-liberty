 ...
 *******************************************************************************/
package io.openliberty.microprofile.openapi41.fat.tck;
...
public class OpenAPITckTest {
    ...
    @ClassRule
    public static RepeatTests repeatTests = MicroProfileActions.repeatIf(SERVER_NAME, TCKUtilities::areAllFeaturesPresent, MicroProfileActions.MP71_EE10,
    ...
    @Test
    public void testOpenAPI41Tck() throws Exception {
